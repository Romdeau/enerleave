...
class AccommodationsControllerTest < ActionController::TestCase
  ...
  test "should create accommodation" do
    assert_difference('Accommodation.count') do
      post :create, accommodation: { check_in: @accommodation.check_in, check_out: @accommodation.check_out, comment: @accommodation.comment, preffered_location: @accommodation.preffered_location }
    end
  ...
  test "should update accommodation" do
    patch :update, id: @accommodation, accommodation: { check_in: @accommodation.check_in, check_out: @accommodation.check_out, comment: @accommodation.comment, preffered_location: @accommodation.preffered_location }
    assert_redirected_to accommodation_path(assigns(:accommodation))
  end
