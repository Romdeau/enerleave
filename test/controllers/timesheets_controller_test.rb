...
class TimesheetsControllerTest < ActionController::TestCase
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post :create, timesheet: { timesheet_date: @timesheet.timesheet_date, timeweek_id: @timesheet.timeweek_id, user_id: @timesheet.user_id }
    end
  ...
  test "should update timesheet" do
    patch :update, id: @timesheet, timesheet: { timesheet_date: @timesheet.timesheet_date, timeweek_id: @timesheet.timeweek_id, user_id: @timesheet.user_id }
    assert_redirected_to timesheet_path(assigns(:timesheet))
  end
